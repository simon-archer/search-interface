...
var RovingTabindexRoot = require('./RovingTabindexRoot.js');
...
const useRovingTabindex = (value) => {
    const { elements, getOrderedItems, setFocusableValue, focusableValue, onShiftTab, } = React.useContext(RovingTabindexRoot.RovingTabindexContext);
    return {
        getOrderedItems,
