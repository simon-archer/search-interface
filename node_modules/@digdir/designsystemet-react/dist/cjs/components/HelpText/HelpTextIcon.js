...
const HelpTextIcon = ({ className, filled = false, openState, }) => {
    const d = filled
    ...
    return (jsxRuntime.jsx("svg", { "aria-hidden": true, className: className, "data-state": openState ? 'open' : 'closed', fill: 'none', role: 'img', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg', children: jsxRuntime.jsx("path", { clipRule: 'evenodd', d: d, fill: 'currentColor', fillRule: 'evenodd' }) }));
};
